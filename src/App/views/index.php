...
<section class="container mx-auto mt-12 p-4 bg-white shadow-md border border-gray-200 rounded">
  <div class="flex items-center justify-between border-b border-gray-200 pb-4">
    <h4 class="font-medium">Transaction List - test</h4>
        ...
        <tr>
          ...
          <td class="p-4 text-sm text-gray-600 flex justify-center space-x-2">
            ...
            <form action="/transaction/<?php echo e($transaction['id']); ?>" method="POST">
              <!-- hidden input allows us to override method -->
              <input type="hidden" name="_METHOD" value="DELETE" />
  ...
  <nav class="flex items-center justify-between border-t border-gray-200 px-4 sm:px-0 mt-6">
    ...
    <div class="hidden md:-mt-px md:flex">
      <?php foreach ($pageLinks as $pageNum => $pageLink) : ?>
        <a href="/?<?php echo e($pageLink) ?>" class="<?php echo $pageNum + 1 === $currentPage ? "border-indigo-500 text-indigo-600" : "border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300" ?> inline-flex items-center border-t-2 px-4 pt-4 text-sm font-medium">
          <?php echo $pageNum + 1; ?>
        </a>
      <?php endforeach; ?>
